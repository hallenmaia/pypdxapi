...
class ParadoxHD77(ParadoxCamera):
    ...
    def __init__(self, host: str, port: int, module_password: str, **kwargs) -> None:
        ...
        :param client_session: (optional) aiohttp.ClientSession for performing HTTP requests. If not provided,
            a new one will be created and destroyed.
    ...
    async def login(self, usercode: str, username: str) -> dict:
        ...
        data = await self.api_request('POST', endpoint='/app/login', payload=payload, result_code=33554432)
    ...
    async def pingstatus(self) -> dict:
        ...
        return await self.api_request('POST', endpoint='/app/pingstatus', payload=payload, result_code=35127296)
    ...
    async def getstatus(self, status_type: int, keep_alive: bool = False) -> dict:
        ...
        return await self.api_request('POST', endpoint='/app/getstatus', payload=payload, result_code=33619968)
    ...
    async def rod(self, action: int = 3, rec_resolution: int = 720) -> dict:
        ...
        return await self.api_request('POST', endpoint='/app/rod', payload=payload, result_code=33816578)
    ...
    async def getitemlist(self, items_count: int = 150, direction: str = 'Ascending', order_by: str = 'date',
        ...
        return await self.api_request('POST', endpoint='/fil/getitemlist', payload=payload, result_code=33882112)
    ...
    async def deleteitem(self, item_id: str) -> dict:
        ...
        return await self.api_request('POST', endpoint='/fil/deleteitem', payload=payload, result_code=34144256)
    ...
    async def playback(self, item_id: str, action: int = 0) -> dict:
        ...
        return await self.api_request('POST', endpoint='/fil/playback', payload=payload, result_code=544210944)
    ...
    async def getthumbnail(self) -> Any:
        ...
        return await self.api_request('POST', endpoint='/fil/getthumbnail', payload=payload, result_code=0)
